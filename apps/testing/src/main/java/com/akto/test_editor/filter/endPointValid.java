...
public class endPointValid {

    private FilterAction filterAction;
    private static final LoggerMaker loggerMaker = new LoggerMaker(endPointValid.class);
    ...
    public endPointValid(FilterNode node, RawApi rawApi, RawApi testRawApi, ApiInfo.ApiInfoKey apiInfoKey, List<String> matchingKeySet, List<BasicDBObject> contextEntities, boolean keyValOperandSeen, String context, Map<String, Object> varMap, String logId) {
        this.node = node;
        this.rawApi = rawApi;
        this.testRawApi = testRawApi;
    ...
    public DataOperandsFilterResponse invoke() {
